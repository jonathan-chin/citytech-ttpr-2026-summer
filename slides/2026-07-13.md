...
# Your Notebook Is Your Report

Build your notebook to be **read top to bottom**, like a report: interleave narration with your data and charts.

- **Markdown cells** for the story: headings, your questions, what you found
- **Code cells** for the work: the DataFrame, the cleaning, the seaborn plots
- Alternate them so a reader can follow your reasoning

**Make a cell Markdown:** select it, press `Esc` then `M` (or use the cell-type dropdown), then `Shift+Enter` to render.

Docs: [Working With Markdown Cells](https://jupyter-notebook.readthedocs.io/en/latest/examples/Notebook/Working%20With%20Markdown%20Cells.html)
